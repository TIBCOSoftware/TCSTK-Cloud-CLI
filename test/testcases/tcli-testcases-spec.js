...
*/
  ...
  it('TCLI: Discover', async function () {
    ...
    expect(run(CLI_EXECUTOR + 'show-discover-datasets -a NONE')).toBe(true, 'Command: ' + cObj.command)
    expect(run(CLI_EXECUTOR + 'show-discover-datasets -a ALL')).toBe(true, 'Command: ' + cObj.command)
